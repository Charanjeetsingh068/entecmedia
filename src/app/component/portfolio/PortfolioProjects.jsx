      ...
      <div>
        {projects.map((project, index) => (
          <div
            ...
            className={`border-t bg-[#140505] z-2 overflow-hidden border-b min-[992px]:px-[87px] px-10 max-[576px]:px-6 relative py-10 min-[1200px]:py-16 transition-colors duration-500 cursor-none ${
              active === index ? "border-red-500" : "border-gray-500"
            }`}
          >
